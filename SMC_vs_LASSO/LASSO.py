## generating LASSO results for different indices
...
def getInitialResultsLASSO(df, indexName, numStocks):
    ...
    for rollPeriod, rollInfo in rollPeriodInfoDict.items():
      ...
      subset, alpha, X, y = selectSubsetLASSO( rollPeriod, rollInfo , numStocks)
      betaLasso = linearRegBeta(subset, X, y)
      baseIndexLevels, lassoIndexLevels, trackingError = getTrackingError( rollPeriod, rollInfo, subset, betaLasso )
      rollInfo['betaLasso'] = betaLasso
      rollInfo['lassoIndexLevels'] = lassoIndexLevels
...
def main():
    ...
    rollPeriodInfoDict = getInitialResultsLASSO(df, indexName, numStocks)
    ...
    getStockSelectionFrequency(df, rollPeriodInfoDict, "LASSO")
    ...
    plotSubsetBetas(rollPeriodInfoDict, relevantPeriods, "LASSO")
